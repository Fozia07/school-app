    ...
    <div className="min-h-screen flex items-center justify-center bg-background p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground">Sign up for the school management system</p>
          <p className="text-sm text-muted-foreground mt-2">Note: Account creation requires admin approval</p>
        </div>
